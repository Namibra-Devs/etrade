                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="axil-order-summery order-checkout-summery">
                                ...
                                <button type="submit" id="checkout-form" class="axil-btn btn-bg-primary checkout-btn">Place Order</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="cart-content-wrap">
            ...
            <div class="cart-footer">
                ...
                <div class="group-btn">
                    ...
                    <a id="checkout-form" class="axil-btn btn-bg-secondary checkout-btn">Checkout</a>
                </div>
            </div>
        </div>
    </div>
