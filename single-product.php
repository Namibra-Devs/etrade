    ...
    <main class="main-wrapper">
        ...
        <div class="axil-single-product-area bg-color-white">
            <div class="modal-body">
                <div style="
    margin-left: 2rem; margin-top: 7rem;" class="single-product-thumb">
                    <div class="row">
                        ...
                        <div class="col-lg-5 mb--40">
                            <div class="single-product-content">
                                <div class="inner">
                                    ...
                                    <p class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores vel, repellat et saepe nulla exercitationem. Repellendus sint nostrum, rerum, sunt minima velit alias quia deleniti, delectus laudantium dolorum id at</p>
